namespace Rabbit.IWasThere.Data.EF.Migrations
{
    ...
    public partial class FixCountAllMessagesSP2 : DbMigration
    {
...
";
        ...
        private string UpScripts
        {
            ...
            {
                return @"
/****** Object:  StoredProcedure [dbo].[CountAllMessages]    Script Date: 09/10/2015 15:58:26 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[CountAllMessages]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[CountAllMessages]
GO
...
AS
BEGIN
	SELECT CAST('7573A0E7-B94B-4752-AFE5-A426DD9B454A' AS UNIQUEIDENTIFIER) AS CategoryId, COUNT(m.Id) AS MessageCount FROM Message m
END
GO
";
            }
